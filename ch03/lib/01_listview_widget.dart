...
class ListViewTest3 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<User> userList = [
      ...
      User('a102', '김춘추', '1990-09-02', 21, 'https://picsum.photos/id/238/200/300'),
      User('a103', '장보고', '1990-09-03', 33, 'https://picsum.photos/id/239/200/300'),
      User('a104', '강감찬', '1990-09-04', 43, 'https://picsum.photos/id/240/200/300'),
      User('a105', '이순신', '1990-09-05', 53, 'https://picsum.photos/id/241/200/300')
    ];

    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(title: Text('03.ListView.seperated 실습'),),
        body: ListView.separated(         // ListView.separated는 ListView.builder에서 목록 구분선을 커스텀 할 수 있는 구분선
